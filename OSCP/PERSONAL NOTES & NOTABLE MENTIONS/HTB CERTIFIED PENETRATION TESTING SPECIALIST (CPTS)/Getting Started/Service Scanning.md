...
```shell-session
frodonomojo@htb[/htb]$ nmap 10.129.42.253
...
```shell-session
frodonomojo@htb[/htb]$ nmap -sV -sC -p- 10.129.42.253
...
```shell-session
frodonomojo@htb[/htb]$ locate scripts/citrix
...
```shell-session
frodonomojo@htb[/htb]$ nc -nv 10.129.42.253 21
...
```shell-session
frodonomojo@htb[/htb]$ nmap -sC -sV -p21 10.129.42.253
...
```shell-session
frodonomojo@htb[/htb]$ ftp -p 10.129.42.253
...
```shell-session
frodonomojo@htb[/htb]$ cat login.txt 
...
```shell-session
frodonomojo@htb[/htb]$ nmap --script smb-os-discovery.nse -p445 10.10.10.40
...
```shell-session
frodonomojo@htb[/htb]$ nmap -A -p445 10.129.42.253
...
```shell-session
frodonomojo@htb[/htb]$ smbclient -N -L \\\\10.129.42.253
...
```shell-session
frodonomojo@htb[/htb]$ smbclient \\\\10.129.42.253\\users
...
```shell-session
frodonomojo@htb[/htb]$ smbclient -U bob \\\\10.129.42.253\\users
...
```shell-session
frodonomojo@htb[/htb]$ snmpwalk -v 2c -c public 10.129.42.253 1.3.6.1.2.1.1.5.0
...
```shell-session
frodonomojo@htb[/htb]$ snmpwalk -v 2c -c private  10.129.42.253 
...
```shell-session
frodonomojo@htb[/htb]$ onesixtyone -c dict.txt 10.129.42.254
